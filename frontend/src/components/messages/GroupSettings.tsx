...
import { X, UserPlus, Trash2, Edit2, Check, Users, Upload, Camera } from "lucide-react";
        ...
        <div className="text-center mt-6">
          <div className="inline-block">
            ...
            <div
              ...
              onKeyPress={e => { if (e.key === 'Enter' || e.key === ' ') avatarInputRef.current?.click(); }}
            ...
            >
              {thread.groupAvatar ? (
                ...
                />
                  ...
                  <Users size={24} className="text-sub dark:text-sub-dark " />
                </div>
              )}
            </div>
            <br />
            <p className="text-sm inline text-sub dark:text-sub-dark">
              {isUploadingAvatar ? "Uploading..." : "Click photo to upload new avatar"}
            </p>
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          {isEditingName ? (
            ...
            <div className="flex items-center justify-between p-3 bg-panel dark:bg-panel-dark rounded-lg">
              ...
              >
                <Edit2 size={18} className="text-text dark:text-text-dark" />
              </button>
            </div>
          )}
        </div>
