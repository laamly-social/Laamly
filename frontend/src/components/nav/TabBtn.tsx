...
export default function TabBtn({ icon: Icon, label, active, to }: { icon: LucideIcon; label: string; active: boolean; to: string }) {
   return (
      <Link
         to={to}
         className={clsx(
            ...
            active && "!bg-accent !text-white !border-transparent hover:!bg-accent"
         )}
      >
         <Icon size={16} /> {label}
      </Link>
