...
const AVAILABLE_PODCASTS: PodcastFeed[] = [
   {
      ...
      description:
         "The latest news and updates from the Linux and Open Source world",
   ...
   },
   {
      ...
      description:
         "Weekly podcast covering Linux news and community discussions",
   ...
   },
   {
      ...
      description:
         "NPR's morning news podcast with the three biggest stories of the day",
...
export default function Podcasts() {
   ...
   const parsePodcastInfo = (xmlDoc: Document) => {
      const title =
         xmlDoc.querySelector("channel > title")?.textContent || "Podcast Feed";
      const author =
         xmlDoc.querySelector("channel > itunes\\:author, channel > author")
      ...
      return (
         <div className="container mx-auto p-4 md:p-8 max-w-7xl">
            <div className="text-center py-10">
               <svg
                  className="animate-spin h-8 w-8 text-accent dark:text-accent-dark mx-auto"
               ...
               <p className="mt-2 text-sub dark:text-sub-dark">
                  Fetching Episodes...
               </p>
            </div>
         </div>
         ...
         <div className="container mx-auto p-4 md:p-8 max-w-7xl">
            ...
            <div className="text-center bg-red-900/50 border border-red-500 p-4 rounded-lg">
               <h3 className="font-bold text-lg text-text dark:text-text-dark">
                  Failed to Load Podcast Feed
               </h3>
               <p className="text-sub dark:text-sub-dark">
                  Could not fetch the RSS feed. The server might be down or
                  there could be a network issue. Please try again later.
               </p>
            </div>
         </div>
      );
      ...
      return (
         <div className="container mx-auto p-4 md:p-8 max-w-7xl">
            <header className="mb-8">
               <h1 className="text-4xl font-bold text-text dark:text-text-dark mb-2">
                  Podcasts
               </h1>
               <p className="text-lg text-sub dark:text-sub-dark">
                     ...
                     <div className="text-left text-text dark:text-text-dark mt-6 max-h-48 overflow-y-auto w-full text-sm custom-scrollbar">
                        <p>
                           {currentEpisode?.description ||
                              "The description of the selected episode will appear here."}
                        </p>
                     </div>
                  </div>
               </div>
