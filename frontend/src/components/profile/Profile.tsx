    ...
    <div className="profile max-w-2xl mx-auto px-4 sm:px-0">
      ...
      <Card className="profile__header">
        ...
        <div className="px-4 sm:px-6 pb-4 sm:pb-6">
          ...
          {/* Additional Info */}
          <div className="flex flex-wrap gap-3 sm:gap-4 mb-3 sm:mb-4 text-sub dark:text-sub-dark text-xs sm:text-sm">
          ...
          <div className="flex gap-4 sm:gap-6 text-xs sm:text-sm">
            <div>
              <strong className="text-text dark:text-text-dark font-bold">{originalPosts.length}</strong>
              <span className="text-sub dark:text-sub-dark ml-1">Posts</span>
            </div>
          </div>
        </div>
      </Card>
